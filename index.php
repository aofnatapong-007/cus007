    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12"> <br>
                <h1>รายชื่อลูกค้า <a href="addcustomer.php" class="btn btn-info float-end">เพิ่มข้อมูล</a> </h1>
                    ...
                    <tbody>
                        ...
                        foreach ($result as $r) { ?>
                            <tr>
                                ...
                                <td><a href="updateCustomerForm_stu.php?CustomerID=<?= $r['CustomerID'] ?>" class="btn btn-warning btn-sm">แก้ไข</a></td>
